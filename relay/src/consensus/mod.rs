...
pub use ops::{
    ...
    note_phase_applied, note_slot_present, observe_leave, reachable_frame, record_departure,
    ...
    retained_load_states, session_closed, session_initial_buffer_turns, session_started,
    set_region_labels, set_session_shape, slot_departed, slot_has_started, slot_homed,
