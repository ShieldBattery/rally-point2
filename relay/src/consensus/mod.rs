...
pub use ops::{
    ...
    claim_silent_slots, commanded_phase_delay, connection_epoch_matches,
    ...
    ingest_arrival_phase, leave_reconcile, leave_schedulable, maker_exists, mark_session_started,
    normalize_observed_leave, note_forward_advance, note_phase_applied, note_slot_present,
    observe_leave, reachable_frame, record_departure, record_departure_for_epoch,
    record_peer_slot_started, record_result, record_slot_connected, record_slot_started,
    reevaluate_session_start, reinstate_slot, remove_slot_for_epoch, reopen_close_report,
    result_for, retained_load_state, retained_load_states, session_closed,
