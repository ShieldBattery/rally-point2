...
impl DecisionMakers {
    ...
    pub fn ingest_local_condition(
        ...
        self.ingest_conditions(key, std::slice::from_ref(conditions), 0, true)
    }
    ...
    pub(in crate::consensus) fn ingest_conditions(
        ...
        self.record_buffer_event(key, directive, inputs);
        Some(decision)
    }
    ...
    pub fn ingest_remote_conditions(
        ...
        self.ingest_conditions(key, &conditions.slots, mesh_rtt_us, false)
    }
    ...
    pub fn active_directive(&self, key: &SessionKey) -> Option<BufferDirective> {
    ...
    pub fn observe_directive(&self, key: &SessionKey, directive: &BufferDirective) {
        let over_ceiling = {
            let mut makers = self.lock();
